...
auto module_RNHealthConnectSpec = RNHealthConnectSpec_ModuleProvider(moduleName, params);
if (module_RNHealthConnectSpec != nullptr) {
return module_RNHealthConnectSpec;
}
  return nullptr;
}
